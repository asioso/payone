 ...
 */
$this->headScript()->appendFile('/static/js/payment/jquery-birthday-picker.min.js');
?>
...
<div class="panel-body">
    <div class="checkout-dropdown payone-checkout-dropdown">
        <form>
            <div class="alert alert-danger invoice-birthday-error payone-error" style="display:none;">
                <?= $this->translate('payment.payone-seamless.invoice.birthday-error') ?>
            </div>
            ...
            <?= $this->translate('payment.payone-seamless.pay-now.INVOICE.birthdate') ?>
            <div id="payolution-birthday" data-year-text="<?= $this->translate('payment.payone.birthdate-year') ?>"
                 data-month-text="<?= $this->translate('payment.payone.birthdate-month') ?>"
                 data-day-text="<?= $this->translate('payment.payone.birthdate-day') ?>"></div>
            ...
            <a class="btn btn-primary js-payone-payment-submit"
               data-validate-url="<?= Pimcore\Tool::getHostUrl() ?><?= $this->pimcoreUrl(['controller' => 'BsPayone', 'action' => 'validate-invoice-payment'], 'action', true) ?>"><?= $this->translate('payment.payone-seamless.pay-now.INVOICE') ?></a>
        </form>
    </div>
</div>